# 🔢 5-Day NumPy Projects — Beginner’s Numerical Computing Portfolio
...
| No. | Project Name                          | Domain / Context        | Core NumPy Skills |
|-----|---------------------------------------|------------------------|------------------|
...
### 🥵 Weather Temperature Simulation
- **Objective:** Simulate 30 days of temperature and analyze patterns.  
- **Insights:** Hottest/coldest day, weekly averages, days above/below thresholds, statistics.

### 🏦 Bank ATM Cash Flow Analysis
- **Objective:** Analyze ATM deposits & withdrawals.  
- **Insights:** Daily balances, negative balance days, week with highest cash flow.
